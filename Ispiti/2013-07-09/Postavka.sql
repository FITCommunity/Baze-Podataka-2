...
sljedecem formatu: CompanyName(Grad,Adresa) - u izlaz ukljuèiti zagrade, telefon dobavljaca, cijena po komadu, 
...
te ukupnu kolièinu prodatih proizvoda. Uslovi su sljedeci:
...
- Takoder, u listu ukljuèiti i one proizvode ciji se broj završava slovom 'L' i bijele su boje,
...
/*8.
 U vašoj bazi podataka kreirajte view koji æe sadržavati sljedeca polja: ime kupca, prezime kupca, telefon, 
